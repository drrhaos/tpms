...
class Aa55SerialProtocolTest {
    ...
    fun feed_parsesRealDongleFrame() {
        ...
        val frame = byteArrayOf(
            0x55.toByte(), 0xAA.toByte(), 0x08, 0x00, 0x47, 0x41, 0x00, 0xF1.toByte()
        )
        val sensors = protocol.feed(frame, 1_000L) { null }
    ...
    fun feed_parsesMultipleFramesInOneChunk() {
        val chunk = byteArrayOf(
            0x55.toByte(), 0xAA.toByte(), 0x08, 0x00, 0x47, 0x41, 0x00, 0xF1.toByte(),
            0x55.toByte(), 0xAA.toByte(), 0x08, 0x01, 0x46, 0x43, 0x00, 0xF3.toByte(),
            0x55.toByte(), 0xAA.toByte(), 0x08, 0x10, 0x43, 0x43, 0x00, 0xE7.toByte(),
            0x55.toByte(), 0xAA.toByte(), 0x08, 0x11, 0x44, 0x42, 0x00, 0xE0.toByte(),
        )
